...
import { Button, List, Loader, ButtonGroup, Icon } from 'semantic-ui-react'
...
const TopicList = ({ courseId }) => {
            ...
            <List.Content>
                <List.Content>
                    <ButtonGroup floated='right'>
                        ...
                        <Button primary onClick={() => editTopicId.set(topic._id)}><Icon name='edit' circular size='small'/></Button>
                    </ButtonGroup>
                </List.Content>
    ...
    return (
        <div>
            <Button positive onClick={() => editTopicId.set('0')}>Topic <Icon name='add' circular size='small'/></Button>
            {topics}
        </div>
    )
}
